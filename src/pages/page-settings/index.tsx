...
export const SettingsPage: React.FC = () => {
  ...
  const [defaultZapAmount, setDefaultZapAmount] = React.useState<string>("");
  ...
  const handleSaveDefaultZapAmount = React.useCallback(() => {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        />
        <Button onClick={handleSaveDefaultZapAmount} variant="secondary">
        ...
        {relaySource === "default" && user && (
          <Alert>
            ...
            <AlertDescription>
              ...
              customize or refresh to try again.
            </AlertDescription>
          </Alert>
        )}
