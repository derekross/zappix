...
export const HoverCardRoot: React.FC<HoverCardRootProps> = (props) => {
  return <HoverCardPrimitive.Root data-slot="hover-card" {...props} />;
};

export type HoverCardTriggerProps = React.ComponentProps<typeof HoverCardPrimitive.Trigger>;

export const HoverCardTrigger: React.FC<HoverCardTriggerProps> = (props) => {
...
export const HoverCardContent: React.FC<HoverCardContentProps> = (props) => {
  const { className, align = "center", sideOffset = 4, ...componentProps } = props;
